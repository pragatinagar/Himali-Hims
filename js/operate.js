...
row.style.textAlign="center";
  ...
  {	
	...
	r[i].children[13].children[0].value=r[i].children[3].children[0].value*r[i].children[8].children[0].value;	
	...
	r[i].children[16].children[0].value=r[i].children[6].children[0].value*r[i].children[11].children[0].value;	
		   ...
		   r[i].children[17].children[0].value='';
		    if(r[i].children[13].children[0].value == 0)
		   r[i].children[13].children[0].value='';
