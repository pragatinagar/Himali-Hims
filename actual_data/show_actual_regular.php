...
$start_from = ($page-1) * $num_rec_per_page; 
		...
		$result = select_limit_pagination_forprojectdetail('actual_regular',$start_from,$num_rec_per_page);   ?>
  ...
  <input type="hidden" value="actual_regular" id="table" />
...
<?php include('pagination.php');
	if(isset($thisForpagination) == 'yes')
	 pagination_condition('actual_regular','show_actual_regular',$num_rec_per_page);	
	 else
	  pagination('actual_regular','show_actual_regular',$num_rec_per_page,$projct);	
