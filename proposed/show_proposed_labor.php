...
<?php
  ...
  ?>
        ...
        <input type="hidden" name="table" value="labor" />
        <input type="submit" class="add-labor fr mr" value="Export Data" />
        </form>      
  <h2 style="color:#069;">Proposed Labor List</h2>
...
$result = select_limit_pagination_forprojectdetail('labor',$start_from,$num_rec_per_page);   ?>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#D0D0E8"><strong>Type</strong></td>
    ...
    <td align="center" bgcolor="#D0D0E8"><strong>Delete</strong></td>
       ...
       <input type="hidden" value="labor" id="table" />           
    ...
    <td height="30" align="center"><?php echo $data['type'];?></td>
    ...
    <td height="30" align="center"><?php if($_SESSION['id2'] == $data['userId']){ ?><a href="edit_proposed_labor.php?page=show_proposed_labor&table=labor&pid=<?php echo $data[0];?>" title="Edit"><div class="edit"></div></a><?php } ?></td>
    <td height="30" align="center"><?php if($_SESSION['id2'] == $data['userId']){ ?><a href="deleteMe.php?page=show_proposed_labor&table=labor&pid=<?php echo $data[0];?>" onclick="return confirm('sure to delete !');" title="Delete"><div class="delete"></div></a><?php } ?></td>
    </tr><?php } 	?>
</table>
...
<?php 
		...
		pagination_condition('labor','show_proposed_labor',$num_rec_per_page);	
		else
		pagination('labor','show_proposed_labor',$num_rec_per_page,$projct);	
