...
$start_from = ($page-1) * $num_rec_per_page; 
		...
		$result = select_limit_pagination_forprojectdetail('expenses',$start_from,$num_rec_per_page);
...
<div id="show_tableData"><table width="100%" cellpadding="5" cellspacing="1" bgcolor="#999"> 
  ...
  <tr>
    ...
    <td height="30" align="center"><?php if($_SESSION['id2'] == $data['userId']){ ?><a href="edit_proposed_labor.php?table=labor&pid=<?php echo $data[0];?>" title="Edit"><div class="edit"></div></a><?php } ?></td>
