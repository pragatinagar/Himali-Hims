...
<?php
 ...
 ?>
<script src="../js/regular_actual.js"></script>
<script src="../js/format_convert.js"></script>
<script src="../js/common_actual.js"></script> 
<script src="../js/dChecking_regular.js"></script> 

<div class="content-wrapper">
        
<form action="insert_regular.php" method="post" id="regForm">
 	<h3 style="color:#069;">Regular Employment</h3> 
 ...
 <tr>
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><input type="text" name="sn[]" style="width: 40px;"/></td>
    <td align="center" bgcolor="#FFFFFF">
    <input type="hidden" name="userId" value="<?php echo $_SESSION['id'];?>" />
    <div class="dropdown">
    <select name="type_actual[]" class="dropdown-select">
   ...
   <td align="center" bgcolor="#FFFFFF">
   <div class="dropdown">
<select name="sex_actual[]" class="dropdown-select">
...
<option value="female">Female</option></select></div>
   ...
   <td align="center" bgcolor="#FFFFFF">   
   <div class="dropdown"> 
     <select name="caste_actual[]" class="dropdown-select">
      ...
      <option value="Other">Others</option>
        ...
        <td align="center" bgcolor="#FFFFFF">
        <div class="dropdown">
      <select name="family_actual[]" id="family_actual" class="dropdown-select">
        ...
        <td align="center" bgcolor="#FFFFFF">
        <div class="dropdown">
      <select name="employee_actual[]" id="employee_actual" class="dropdown-select">
       <option value="">Select</option>
        <option value="yes">Yes</option>
        <option value="no">No</option>
        </select></div>
